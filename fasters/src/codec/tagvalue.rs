...
fn encode_field(
    ...
    match &value {
        ...
        slr::FixFieldValue::Int(int) => write.extend_from_slice(int.to_string().as_bytes()),
...
pub trait TagLookup {
    ...
    fn lookup(&mut self, tag: u32) -> Result<datatypes::DataType, Self::Error>;
}
...
fn field_value(datatype: DataType, buf: &[u8]) -> Result<slr::FixFieldValue, Error> {
    ...
    Ok(match datatype {
        ...
        DataType::Float => slr::FixFieldValue::Float(
            str::from_utf8(buf)
