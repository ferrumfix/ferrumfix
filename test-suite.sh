...
cargo test --no-default-features --features "fix40, fix41, fix42, fix43, fix50, fix50sp1, fix50sp1, fixt11, fixp, fixs, fast-encoding, json-encoding, sofh, utils-bytes, utils-chrono, utils-decimal, utils-openssl, utils-rust-decimal, utils-slog, utils-tokio"
