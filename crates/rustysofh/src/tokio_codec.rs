...
/// let mut codec = rustysofh::TokioCodec::default();
/// let mut destination = BytesMut::new();
/// codec.encode(rustysofh::Frame::new(0x1337, payload.clone()), &mut destination);
///
/// assert_eq!(
///     codec.decode(&mut destination).unwrap(),
///     Some(rustysofh::Frame::new(0x1337, payload))
/// );
/// ```
