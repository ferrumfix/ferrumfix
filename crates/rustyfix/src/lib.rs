...
//!
//! RustyFix is a collection of reusable components to produce and consume
//! FIX-compliant data. It is *not* a FIX engine, although you can very easily
//! build one with RustyFix. RustyFix is intended to be:
//!
//!  - **Comprehensive**.
...
//!    the hot paths.
//!
//! Please check out the [README](https://github.com/rusty-engine/rustyfix/) for more
//! general information regarding RustyFix.
//!
//! # Cargo features
//!
//! RustyFix puts a lot of functionality behind optional features in order to
...
//!
//! ```toml
//! rustyfix = { version = "0.1", features = ["codegen"] }
//! ```
//!
...
//!   **A.** Use [`rustyfix::tagvalue::Decoder`](crate::tagvalue::Decoder) and
//!   [`rustyfix::tagvalue::DecoderStreaming`](crate::tagvalue::DecoderStreaming).
...
#![doc(html_root_url = "https://docs.rs/rustyfix/")]
#![warn(missing_docs)]
#![deny(
    //unused FIXME,
...
#[cfg(feature = "codegen")]
pub use rustyfix_codegen as codegen;
